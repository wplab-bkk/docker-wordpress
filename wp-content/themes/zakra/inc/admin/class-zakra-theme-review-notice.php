...
class Zakra_Theme_Review_Notice {
	...
	public function zakra_theme_review_notice() {
		...
		<div class="notice updated theme-review-notice" style="position:relative;">
			...
			<a class="notice-dismiss" style="text-decoration:none;"
			   href="?nag_zakra_ignore_theme_review_notice_partially=0"></a>
		</div>
	...
	public function zakra_theme_rating_notice_data_remove() {
		...
		if ( $ignored_notice ) {
			delete_user_meta( $user_id, 'zakra_ignore_theme_review_notice' );
		}

		// Delete partial notice remove data.
		if ( $ignored_notice_partially ) {
			delete_user_meta( $user_id, 'nag_zakra_ignore_theme_review_notice_partially' );
		}
